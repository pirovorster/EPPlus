...
namespace OfficeOpenXml.Drawing
{
    ...
    public class ExcelDrawings : IEnumerable<ExcelDrawing>, IDisposable
    {
        ...
        /// <returns></returns>
        public Custom.ExcelPicture AddPicture(string name, ImageModel imageModel)
        {
            return AddPicture(name, imageModel, null);
        }
        /// <summary>
        /// Add a picure to the worksheet
        /// </summary>
        ...
        /// <param name="Hyperlink">Picture Hyperlink</param>
        /// <returns></returns>
        public Custom.ExcelPicture AddPicture(string Name, ImageModel imageModel, Uri Hyperlink)
        {
            if (imageModel != null)
            {
                if (_drawingNames.ContainsKey(Name))
                ...
                Custom.ExcelPicture pic = new Custom.ExcelPicture(this, drawNode, imageModel, Hyperlink);
                pic.Name = Name;
                _drawings.Add(pic);
                _drawingNames.Add(Name, _drawings.Count - 1);
                return pic;
